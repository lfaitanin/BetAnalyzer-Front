...
export default function BolasDe3Page() {
  ...
  return (
    <div className="space-y-4 md:space-y-6 p-2 md:p-6 bg-transparent">
      <h1 className="text-xl md:text-3xl font-black text-foreground tracking-tight">Histórico de Apostas - Bolas de 3</h1>
            ...
            <tbody className="divide-y divide-border">
              {bets.map((bet) => (
                <tr key={bet.id} className="hover:bg-muted/50 transition-colors">
                  ...
                  <td className="px-3 md:px-6 py-3 md:py-4 whitespace-nowrap text-xs md:text-sm text-muted-foreground">R$ {bet.stake.toFixed(2)}</td>
